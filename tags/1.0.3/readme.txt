=== Delivery Slot Manager for WooCommerce ===
Contributors: jhaparmanand
Tags: woocommerce, delivery, datepicker, cart
...
A WooCommerce plugin that adds a delivery date & time picker before "Add to Cart" and displays selected data in the cart.
...
== Installation ==
1. Upload the `delivery-slot` folder to the `/wp-content/plugins/` directory.
2. Activate the plugin through the "Plugins" menu in WordPress.
3. Go to a WooCommerce product page to see the delivery date & time picker.
...
== Upgrade Notice ==
= 1.0.3 =
Ensure you clear your cache after updating to apply the latest styling fixes.
